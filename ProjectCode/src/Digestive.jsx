...
Command: npx gltfjsx@6.2.13 digestive.glb 
*/
...
export function Digestive(props) {
  ...
  const { nodes, materials } = useGLTF('/digestive.glb')
  return (
    <group {...props} dispose={null} scale={1.5} position={[45, -7, 0]}>
      ...
      <RigidBody type="fixed" >
        ...
        <group position={[-34.559, 3.373, -14.406]} rotation={[-Math.PI / 2, 0, -2.427]} scale={0.216}>
          <PresentationControls snap={true}>
            <group rotation={[Math.PI / 2, 0, 0]}>
              ...
              <mesh onPointerEnter={(e) => setText('Gall Bladder')}
                onPointerLeave={(e) => clear()} geometry={nodes.gallbladder002_Material013_0.geometry} material={materials['Material.013']} position={[0.239, -2.604, 1.254]} rotation={[-1.99, -0.69, 2.815]} scale={6.5} />
              <mesh onPointerEnter={(e) => setText('Hepatic Artery')}
                onPointerLeave={(e) => clear()} geometry={nodes.hepatic_artery001_Material_0.geometry} material={materials['Material.004']} position={[-0.994, -1.083, -0.682]} rotation={[-0.466, 0.813, -0.145]} scale={6.5} />
              <mesh onPointerEnter={(e) => setText('Inferior Vena Cava')}
                onPointerLeave={(e) => clear()} geometry={nodes.inferior_vena_cava001_Material012_0.geometry} material={materials['Material.012']} position={[-3.015, 7.079, 0.119]} rotation={[-1.571, -0.136, 0.001]} scale={6.5} />
        ...
        <mesh geometry={nodes.Cube006.geometry} material={nodes.Cube006.material} position={[-21.973, 2.97, -1.853]} rotation={[-0.565, 0, -1.454]} scale={[1.518, 1.02, 1.349]} />
        <mesh geometry={nodes.Text001.geometry} material={materials['Material.022']} position={[-23.618, 8.856, -0.832]} rotation={[1.587, 0.018, 1.571]} />
      </RigidBody>
    </group>
  )
}

useGLTF.preload('/digestive.glb')