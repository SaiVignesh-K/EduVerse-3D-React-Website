...
Command: npx gltfjsx@6.2.13 bioroom1.glb 
*/
...
export function Bioroom(props) {
  const { nodes, materials } = useGLTF('/bioroom1.glb')
  return (
    <group {...props} dispose={null}>
      ...
      <mesh geometry={nodes.Text.geometry} material={nodes.Text.material} position={[-8.99, 14.098, -16.641]} rotation={[Math.PI / 2, 0, 0]} scale={2.957} />
    </group>
  )
}

useGLTF.preload('/bioroom1.glb')
